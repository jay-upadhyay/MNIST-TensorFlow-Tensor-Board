...
# Made Changes by Jay Upadhyay for analysis and experimentation
#for 4 different architectures (2 convolution layer, 1 convolution layer, 2 fully connected, 1 fully connected layer)
# and 3 values of the learning rate
# ==============================================================================
import os
...
def mnist_model(learning_rate, use_two_conv, use_two_fc, hparam):
  ...
  if use_two_fc:
    fc1 = tf.nn.relu(fc_layer(flattened, 7 * 7 * 64, 1024, "fc1"))
    embedding_input = fc1
    embedding_size = 1024
